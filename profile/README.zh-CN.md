...
WorkItem 并将其纳入各 Group 的队列，还可以通过基于证据的审查和人类批准协调交付。
...
- [python-sdk](https://github.com/missionweaveprotocol/python-sdk) — 官方 Python 参考实现、
  完整 Agent 运行时、Group 网关、Worker Scheduler、符合性测试运行器、存储适配器和可执行 POC。
- [go-sdk](https://github.com/missionweaveprotocol/go-sdk) — 官方 Go 协议 SDK，提供协议绑定和
  Schema 与测试向量符合性能力。
- [typescript-sdk](https://github.com/missionweaveprotocol/typescript-sdk) — 官方 TypeScript
  协议 SDK，提供协议绑定和 Schema 与测试向量符合性能力。
- [java-sdk](https://github.com/missionweaveprotocol/java-sdk) — 官方 Java 协议 SDK，提供协议
  绑定和 Schema 与测试向量符合性能力。
- [rust-sdk](https://github.com/missionweaveprotocol/rust-sdk) — 官方 Rust 协议 SDK，提供协议
  绑定和 Schema 与测试向量符合性能力。
- [cpp-sdk](https://github.com/missionweaveprotocol/cpp-sdk) — 官方 C++ 协议 SDK，提供协议绑定和
  Schema 与测试向量符合性能力。
