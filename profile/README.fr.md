...
- [python-sdk](https://github.com/missionweaveprotocol/python-sdk) — implémentation de référence
  officielle en Python, environnement d’exécution des Agent, passerelle de Group, Worker Scheduler,
  outil de conformité, adaptateurs de stockage et preuve de concept exécutable.
